                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-4">
                                <div class="form-group local-forms">
                                    ...
                                    <input class="form-control" name="name" type="text" placeholder="Enter Name" value="{{ old('name', $category->name) }}">
                                    @error('name')
                            ...
                            <div class="col-md-6 col-sm-4">
                                <div class="form-group local-forms">
                                    ...
                                    <input class="form-control" name="description" type="text"
                                        placeholder="Enter Description" value="{{ old('description', $category->description) }}">
                                    @error('description')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
