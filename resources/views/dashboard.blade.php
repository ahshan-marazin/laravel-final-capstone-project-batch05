                        ...
                        <table class="table star-student table-hover table-center table-borderless table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <a href="profile.html">
                                            <img class="rounded-circle" src="{{asset('assets/img/profiles/avatar-02.jpg') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <a href="profile.html">
                                            <img class="rounded-circle" src="{{asset('assets/img/profiles/avatar-03.jpg') }}"
                                                width="25" alt="Star Students">
                                            Pennington Joy
                                        </a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <a href="profile.html">
                                            <img class="rounded-circle" src="{{asset('assets/img/profiles/avatar-04.jpg') }}"
                                                width="25" alt="Star Students">
                                            Millie Marsden
                                        </a>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        <a href="profile.html">
                                            <img class="rounded-circle" src="{{asset('assets/img/profiles/avatar-05.jpg') }}"
                                                width="25" alt="Star Students">
                                            John Smith
                                        </a>
                                    </td>
